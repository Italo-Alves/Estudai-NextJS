      ...
      <Container>
        <Content>
          <ContainerButtons>
            <Link href="/study">
              <a className="study">
                <Image src={studyIcon} alt="Estudar" />
                <span>Estudar</span>
              </a>
            </Link>
            ...
            <Link href="/give-classes">
              <a className="give-classes">
                <Image src={giveClassesIcon} alt="Dar aulas" />
          ...
          <section>
            <ContainerWhy>
              ...
              <div>
                <Item>
                  <Image src={logoMoney} alt="Dinheiro" />
                ...
                <Item>
                  <Image src={logoQuestion} alt="Dúvidas" />
